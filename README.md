...
# 📋 Features
Table Reservation: Choose date, time, table, add contact information.
Menu & Ordering: Add items to cart and reserve with order.
User Accounts: Register, login, authorize.
Admin Panel: Access via admin authentication to manage all reservations—view, add, delete and filter by customer name, date or table number—and export data to PDF, Excel or Word.
